...
public class RecyclerView extends ViewGroup {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if(Build.VERSION.SDK_INT>=26){
            ...
            if (context.getTheme().resolveAttribute(android.R.attr.listPreferredItemHeight, outValue, true)){
                mScaledHorizontalScrollFactor=mScaledVerticalScrollFactor=outValue.getDimension(context.getResources().getDisplayMetrics());
            }
        }
    ...
    private void initAutofill() {
        if (Build.VERSION.SDK_INT>=26 && getImportantForAutofill() == View.IMPORTANT_FOR_AUTOFILL_AUTO) {
...
//            TraceCompat.endSection();
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (getOverScrollMode() != View.OVER_SCROLL_NEVER) {
            if (ev != null && (ev.getSource() & InputDevice.SOURCE_MOUSE)==0) {
...
//        Preconditions.checkNotNull(edgeEffectFactory);
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure
            ...
            if (!needsFocusFailureLayout && mLayout.canScrollHorizontally()) {
                boolean rtl = mLayout.getLayoutDirection() == LAYOUT_DIRECTION_RTL;
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        final int rtl = mLayout.getLayoutDirection() == LAYOUT_DIRECTION_RTL ? -1 : 1;
        int rightness = 0;
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_SCROLL) {
            ...
            } else if (Build.VERSION.SDK_INT>=26 && (event.getSource() & InputDevice.SOURCE_ROTARY_ENCODER) != 0) {
                final float axisScroll = event.getAxisValue(MotionEvent.AXIS_SCROLL);
                if (mLayout.canScrollVertically()) {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder holder) {
            if (isAccessibilityEnabled()) {
                ...
                if (itemView.getImportantForAccessibility()
                    ...
                    itemView.setImportantForAccessibility(IMPORTANT_FOR_ACCESSIBILITY_YES);
                }
...
//            }
    ...
    public abstract static class ViewHolder {
        ...
        private int mWasImportantForAccessibilityBeforeHidden = IMPORTANT_FOR_ACCESSIBILITY_AUTO;
        ...
        void resetInternal() {
            ...
            clearPayload();
            mWasImportantForAccessibilityBeforeHidden = IMPORTANT_FOR_ACCESSIBILITY_AUTO;
        ...
        void onEnteredHiddenState(RecyclerView parent) {
            ...
            parent.setChildImportantForAccessibilityInternal(this, IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS);
        }
