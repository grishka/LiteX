...
public class PagerTitleStrip extends ViewGroup {
    ...
    public PagerTitleStrip(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (textAppearance != 0) {
            mPrevText.setTextAppearance(getContext(), textAppearance);
            mCurrText.setTextAppearance(getContext(), textAppearance);
            mNextText.setTextAppearance(getContext(), textAppearance);
        }
