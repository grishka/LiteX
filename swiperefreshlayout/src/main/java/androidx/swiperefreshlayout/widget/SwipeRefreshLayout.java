...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public void setProgressBackgroundColorSchemeResource(@ColorRes int colorRes) {
        setProgressBackgroundColorSchemeColor(getContext().getResources().getColor(colorRes));
    }
    ...
    public void setColorSchemeResources(@ColorRes int... colorResIds) {
        ...
        for (int i = 0; i < colorResIds.length; i++) {
            colorRes[i] = context.getResources().getColor(colorResIds[i]);
        }
...
//    @Override
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed,
                mParentOffsetInWindow/*, consumed*/);
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        return isEnabled() && !mReturningToStart && !mRefreshing
                && (nestedScrollAxes & SCROLL_AXIS_VERTICAL) != 0;
    }
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        ...
        startNestedScroll(axes & SCROLL_AXIS_VERTICAL);
        mTotalUnconsumed = 0;
    ...
    public void onNestedScroll(final View target, final int dxConsumed, final int dyConsumed,
        ...
        onNestedScroll(target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, mNestedScrollingV2ConsumedCompat);
    }
