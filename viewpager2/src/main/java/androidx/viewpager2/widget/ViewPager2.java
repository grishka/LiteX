...
public final class ViewPager2 extends ViewGroup {
    ...
    private class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.Recycler recycler,
                @NonNull RecyclerView.State state, @NonNull AccessibilityNodeInfo info) {
    ...
    private abstract class AccessibilityProvider {
        ...
        void onLmInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        }
...
//                };
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
                @NonNull RecyclerView recyclerView) {
            recyclerView.setImportantForAccessibility(IMPORTANT_FOR_ACCESSIBILITY_NO);
            ...
            if (ViewPager2.this.getImportantForAccessibility()
                ...
                ViewPager2.this.setImportantForAccessibility(IMPORTANT_FOR_ACCESSIBILITY_YES);
            }
        }
        ...
        public boolean onPerformAccessibilityAction(int action, Bundle arguments) {
            ...
            int nextItem = (action == AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD)
                    ? getCurrentItem() - 1
                    : getCurrentItem() + 1;
...
//                            new AccessibilityNodeInfo.AccessibilityAction(actionIdPageForward, null), null,
//                            mActionPageForward);
//                }
//                if (mCurrentItem > 0) {
//                    ViewCompat.replaceAccessibilityAction(viewPager,
//                            new AccessibilityNodeInfo.AccessibilityAction(actionIdPageBackward, null), null,
//                            mActionPageBackward);
//                }
//            } else {
//                if (mCurrentItem < itemCount - 1) {
//                    ViewCompat.replaceAccessibilityAction(viewPager,
//                            new AccessibilityNodeInfo.AccessibilityAction(actionIdPageDown, null), null,
//                            mActionPageForward);
//                }
//                if (mCurrentItem > 0) {
//                    ViewCompat.replaceAccessibilityAction(viewPager,
//                            new AccessibilityNodeInfo.AccessibilityAction(actionIdPageUp, null), null,
//                            mActionPageBackward);
//                }
//            }
        }
        ...
        private void addCollectionInfo(AccessibilityNodeInfo info) {
            ...
            AccessibilityNodeInfo nodeInfoCompat = info;
            AccessibilityNodeInfo.CollectionInfo collectionInfo =
                    AccessibilityNodeInfo.CollectionInfo.obtain(rowCount, colCount,
                            /* hierarchical= */false,
